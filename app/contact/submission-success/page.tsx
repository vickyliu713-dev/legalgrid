  ...
  return (
    <main className="w-full py-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto text-center space-y-4">
        ...
        <a href="/" className="inline-flex items-center justify-center rounded-md bg-secondary text-secondary-foreground h-12 px-6 font-medium hover:bg-secondary/90">Return to homepage</a>
      </div>
    </main>
  );
}
