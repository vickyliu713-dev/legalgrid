...
export default function InvestmentHero(): React.ReactElement {
  return (
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-foreground">
                Investment &amp; Fundraising Agreements
              </h1>
            </div>
            <p className="text-lg text-muted-foreground leading-relaxed">
              We prepare seed and angel investment agreements, convertible notes, loan contracts,  subscription agreements and other essential investment agreements for UK startups and SMEs.
            </p>
