          ...
          <nav className="hidden md:flex items-center absolute left-1/2 transform -translate-x-1/2">
            <div className="rounded-full px-1 py-1 backdrop-blur-md bg-background/80 border border-border shadow-lg relative">
              <div className="flex items-center">
                ...
                <div role="group" dir="ltr" className={`absolute top-full left-1/2 -translate-x-1/2 mt-2 bg-background border border-border rounded-xl shadow-lg items-center justify-center gap-1 p-2 ${servicesOpen ? "flex" : "hidden"}`} tabIndex={0}>
