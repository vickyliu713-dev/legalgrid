              ...
              <div className="flex items-center">
                ...
                <div role="group" dir="ltr" className={`absolute top-full left-0 mt-2 bg-background border border-border rounded-xl shadow-lg p-2 w-72 ${servicesOpen ? "flex" : "hidden"} flex-col`} tabIndex={0}>
                  ...
                  <Link href="/finances" onClick={() => setServicesOpen(false)} className="inline-flex items-center justify-start text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-transparent h-10 px-3 rounded-lg transition-colors relative text-[#737373] hover:text-foreground hover:bg-muted">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-block mr-1.5"><line x1="12" y1="2" x2="12" y2="22"></line><path d="M17 7c0-2.2-1.8-4-4-4h-2a4 4 0 0 0 0 8h2a4 4 0 0 1 0 8H9a4 4 0 0 1-4-4"></path></svg>
                    Finance
                  </Link>
                </div>
                {/* Outside-of-dropdown controls */}
                <div className="flex items-center gap-1 ml-2">
                  <Link href="/resources" onClick={() => setServicesOpen(false)} className="inline-flex items-center justify-center text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-transparent h-10 px-4 py-2 rounded-full transition-colors relative text-[#737373] hover:text-foreground hover:bg-muted">
                  ...
                  <Link href="#contact" onClick={() => setServicesOpen(false)} className="inline-flex items-center justify-center text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-transparent h-10 px-4 py-2 rounded-full transition-colors relative text-[#737373] hover:text-foreground hover:bg-muted">
