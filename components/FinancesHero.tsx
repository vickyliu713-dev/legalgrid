...
export default function FinancesHero(): React.ReactElement {
  return (
    <section className="relative w-full py-16 px-6 md:px-12 bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-foreground">
          Finance &amp; Growth Support
        </h1>
        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
          We prepare R&amp;D tax credit documentation, loan agreements, governance records, and compliance frameworks for UK startups and SMEs.
        </p>
