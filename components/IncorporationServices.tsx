    ...
    <section id="services" className="w-full py-12 md:py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="rounded-xl border border-border/20 bg-gradient-to-br from-card to-primary/5 p-6 hover:border-secondary/40 transition-all duration-300 shadow-sm">
          ...
          <div className="rounded-xl border border-border/20 bg-gradient-to-br from-card to-info/10 p-6 hover:border-secondary/40 transition-all duration-300 shadow-sm">
