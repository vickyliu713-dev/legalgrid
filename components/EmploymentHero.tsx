...
export default function EmploymentHero(): React.ReactElement {
  return (
    <section className="relative w-full py-16 px-6 md:px-12 bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
          We draft director and employee contracts, freelancer agreements, staff handbooks, HR policies and all necessary employment documents for UK startups and SMEs.
        </p>
